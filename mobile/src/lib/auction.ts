// Ported verbatim from the web app's lib/auction.ts.

import { AUCTION_CLOSE_HOURS, EVENT_MAX_MONTHS, EVENT_MIN_DAYS } from "@/lib/config";

export const EVENT_DATE_WINDOW_COPY = "Date must be from 4 days to 12 months out.";
...
const RESERVED_SLUGS = new Set([
  "demo", "new", "events", "login", "admin", "waitlist", "about", "privacy",
  "terms", "contact", "onboarding", "outreach", "inbox", "proof", "me", "api", "auth",
]);
